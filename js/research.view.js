...
(function() {
  ...
  app.report = {
    "group_colour": "red",
    "source": "/reports/pdfs/bovine_methane_proposal.pdf",
    "lesson": "review3",
    "parts": [
      {
        "number": 1,
      ...
      },
      {
        "number": 4,
        "kind": "write",
        "name": "Representation of the pmoCAB Operon"
      },
      {
        "number": 5,
        "kind": "write",
      ...
      },
      {
        "number": 6,
        "kind": "write",
        "name": "Structure of the pmoCAB Operon"
      }
    ]
  }
  ...
  app.html = [
    ...
    `,
    `
    <h2>Representation of the <i>pmoCAB</i> Operon</h2>
    ...
    `,
    `
    <h2>Structure of the <i>pmoCAB</i> Operon</h2>
  ...
  app.View.ReportView = Backbone.View.extend({
    ...
    updateReport: function() {
      ...
      jQuery('#report-content-container textarea').each(function(index, el) {
        // key should be related to how the info will be displayed in the report, instead of entry0, entry1, etc. Maybe use class names?
        //var key = "entry"+index;
        //app.report.parts[app.currentReportPage - 1][key] = jQuery(el).val();

        // this is wrong too, the entries should be keyed to something. Use objects instead?
    ...
    render: function() {
      ...
      // create the html
      jQuery('#report-content-container').append(app.html[app.currentReportPage - 1]);
