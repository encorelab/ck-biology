Skeletor.Mobile.certificationReports = [
{
  "field": "Immunology",
  "colour": "red",
  "parts": [
    {
      "number": 1,
      "kind": "read",
      "name": "Immunology Certification Questions",
      "thumbnail": "",
      "html": `
        <h2>Immunology Certification Questions</h2>
        <p>Working as a team, answer all of the following five questions correctly to earn your certificate of specialization in immunology.</p>`
    },
    {
      "number": 2,
      "kind": "write",
      "name": "",
      "thumbnail": "",
      "question": `Explain how an inflammatory response works, including how it is triggered. Is this an example of innate immunity or adaptive immunity?`,
      "html": `
        <p>Explain how an inflammatory response works, including how it is triggered. Is this an example of innate immunity or adaptive immunity?</p>
    ...
    },
    {
      ...
      "name": "",
      "thumbnail": "",
      "question": `How is the immune system able to distinguish self from non-self?  What happens if it fails to do so?`,
      "html": `
        <p>How is the immune system able to distinguish self from non-self?  What happens if it fails to do so?</p>
        <textarea placeholder="Enter your text here"></textarea>`
    },
    {
      "number": 5,
      ...
      "name": "",
      "thumbnail": "",
      "question": `Systemic Lupus Erythematosus (SLE, or "lupus") is an autoimmune disease characterized by the presence of large amounts of autoantibodies (i.e. antibodies that bind to self antigens) that circulate throughout the body.  The autoantibodies in lupus are called "antinuclear antibodies" (ANA) because they bind to the contents of a cell's nucleus.  As shown in the autoantibodies table (handout), there are many subtypes of ANAs, each of which binds to different proteins or protein complexes within the nucleus. According to this table, what kind of ANAs would be found in patients with SLE?`,
      "html": `
        <p>Systemic Lupus Erythematosus (SLE, or "lupus") is an autoimmune disease characterized by the presence of large amounts of autoantibodies (i.e. antibodies that bind to self antigens) that circulate throughout the body.  The autoantibodies in lupus are called "antinuclear antibodies" (ANA) because they bind to the contents of a cell's nucleus.  As shown in the autoantibodies table (handout), there are many subtypes of ANAs, each of which binds to different proteins or protein complexes within the nucleus:</p>
        <p>According to this table, what kind of ANAs would be found in patients with SLE?</p>
        <textarea placeholder="Enter your text here"></textarea>`
    },
    {
      "number": 6,
      "kind": "write",
      "name": "",
      "thumbnail": "reports/imgs/immunology_question5.png",
  ...
  "parts": [
    {
      "number": 1,
      "kind": "read",
      "name": "Nephrology Certification Questions",
      "thumbnail": "",
      "html": `
        <h2>Nephrology Certification Questions</h2>
        <p>Working as a team, answer all of the following four questions correctly to earn your certificate of specialization in nephrology.</p>`
    },
    {
      "number": 2,
      "kind": "write",
      "name": "",
      "thumbnail": "",
      "question": `Briefly describe the four key functions of the excretory system (i.e. filtration, reabsorption, secretion, and excretion), and identify where each of these processes occurs in humans.`,
      "html": `
        <p>Briefly describe the four key functions of the excretory system (i.e. filtration, reabsorption, secretion, and excretion), and identify where each of these processes occurs in humans.</p>
        <textarea placeholder="Enter your text here"></textarea>`
    },
    {
      "number": 3,
      "kind": "write",
      "name": "",
      "thumbnail": "reports/imgs/nephrology_question2.jpg",
    ...
    },
    {
      ...
      "kind": "write",
      "name": "",
      "thumbnail": "reports/imgs/nephrology_question3.jpg",
  ...
  "parts": [
    {
      "number": 1,
      "kind": "read",
      "name": "Neurology Certification Questions",
      "thumbnail": "",
      "html": `
        <h2>Neurology Certification Questions</h2>
        <p>Working as a team, answer all of the following four questions correctly to earn your certificate of specialization in neurology.</p>`
    },
    {
      "number": 2,
      "kind": "write",
    ...
    },
    {
      ...
      "kind": "write",
      "name": "",
      "thumbnail": "reports/imgs/neurology_questions2and3.jpg",
    ...
    },
    {
      ...
      "kind": "write",
      "name": "",
      "thumbnail": "reports/imgs/neurology_question4.jpg",
      "question": `Neuropsychiatric manifestations of systemic lupus erythematosus (NPSLE) comprise a complex array of neurological, psychiatric and behavioural manifestations. Seizures are one of the most ominous and relevant clinical expressions of damage accrual in SLE.  Seizures occur when a group of neurons begin firing in an abnormal, excessive, and synchronized manner.  An electroencephalography (EEG) may be used to help determine the type of seizure or syndrome present.  An EEG measures voltage fluctuations resulting from ionic current within the neurons of the brain.  The names of the electrode sites use alphabetical abbreviations that identify the lobe or area of the brain which each electrode records from: F = frontal Fp = frontopolar T = temporal C = central P = parietal O = occipital A = auricular (ear electrode). The image below represents EEG results of a patient experiencing NPSLE.  Use the handouts provided to identify the waveform pattern that is present in this image.  Is this pattern generalized or local?  Which hemispheres and/or specific regions of the brain are affected?`,
      "html": `
        <p>Neuropsychiatric manifestations of systemic lupus erythematosus (NPSLE) comprise a complex array of neurological, psychiatric and behavioural manifestations. Seizures are one of the most ominous and relevant clinical expressions of damage accrual in SLE.  Seizures occur when a group of neurons begin firing in an abnormal, excessive, and synchronized manner.</p>
        <p>An electroencephalography (EEG) may be used to help determine the type of seizure or syndrome present.  An EEG measures voltage fluctuations resulting from ionic current within the neurons of the brain.  The names of the electrode sites use alphabetical abbreviations that identify the lobe or area of the brain which each electrode records from:</p>
        <ul>
          <li>F = frontal</li>
          <li>Fp = frontopolar</li>
          <li>T = temporal</li>
          <li>C = central</li>
          <li>P = parietal</li>
          <li>O = occipital</li>
  ...
  "parts": [
    {
      "number": 1,
      "kind": "read",
      "name": "Endocrinology Certification Questions",
      "thumbnail": "",
      "html": `
        <h2>Endocrinology Certification Questions</h2>
        <p>Working as a team, answer all of the following four questions correctly to earn your certificate of specialization in endocrinology.</p>`
    },
    {
      "number": 2,
      "kind": "write",
      "name": "",
      "thumbnail": "reports/imgs/endocrinology_question1.jpg",
    ...
    },
    {
      ...
      "kind": "write",
      "name": "",
      "thumbnail": "reports/imgs/endocrinology_question2.jpg",
    ...
    },
    {
      ...
      "kind": "write",
      "name": "",
      "thumbnail": "reports/imgs/endocrinology_question3.jpg",
